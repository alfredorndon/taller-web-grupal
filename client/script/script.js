...
function verificarGameOver ()
{
    ...
    if (todosLosHits.length == 17) ws.send(JSON.stringify({ type: "player-defeated", gameId: localStorage.getItem("partidaActiva"), playerName: localStorage.getItem("nombreJugador")}));
}
